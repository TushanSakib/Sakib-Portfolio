          ...
          >
            ...
            {/* <div className="flex items-center justify-center w-full lg:w-5/12 mb-6 lg:mb-0">
              <motion.div
                ...
                viewport={{ once: true }}
                className={`relative ${index % 2 === 0 ? 'lg:ml-auto lg:mr-12' : 'lg:mr-auto lg:ml-12'}`}
              >
                <div className="relative inline-block">
                  <div className="absolute inset-0 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-lg blur-md opacity-75"></div>
                  <div className="relative bg-neutral-950 border-2 border-cyan-500/50 rounded-lg px-6 py-3 backdrop-blur-sm">
                    <p className="text-lg font-bold bg-gradient-to-r from-cyan-300 to-blue-300 bg-clip-text text-transparent whitespace-nowrap">
                      Project {project.id}
                    </p>
                  </div>
                </div>
